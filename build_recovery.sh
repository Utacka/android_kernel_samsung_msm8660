...
export INITRAMFS_SOURCE="${KERNELDIR}/../recoveryfs"
...
#
KRNRLS="DreamKernel-GTI9210T-v1.0BETA_2"
...
$TOOLBIN/mkbootimg --kernel $KERNELDIR/arch/arm/boot/kernel --ramdisk $INITRAMFS_TMP.img --cmdline "androidboot.hardware=qcom msm_watchdog.appsbark=0 msm_watchdog.enable=1" --base 0x40400000 --pagesize 2048 --ramdiskaddr 0x41800000 --output $KERNELDIR/recovery.img
rm -v $KERNELDIR/arch/arm/boot/kernel
echo " "
...
cd $KERNELDIR
tar cfv $RELEASEDIR/$ARCNAME.tar recovery.img
